        ...
        <div class="container">
            <div class="card">
                <div class="card-header" style="background-color: #0a2558;">
                    <h4 class="float-left text-light">Add User</h4>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="emp_name" id="" class="form-control" placeholder="Enter Employee Name">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="contact_no" id="" class="form-control" placeholder="Contact Number" max:10,>
                                    <span class="text-danger font-weight-bold">
                                                                    @error('contact_no')
                                                                    {{$message}}
                                                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="">Address Line 1<span class="text-danger text-bold">*</span>:</label>
                                    <input type="text" name="address_line1" id="" class="form-control" placeholder="Address">
                                    <span class="text-danger font-weight-bold">
                                                                    @error('contact_no')
                                                                    {{$message}}
                                                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="address_line2" id="" class="form-control" placeholder="Address">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="">City<span class="text-danger text-bold">*</span>:</label>
                                    <input type="text" name="city" id="" class="form-control" placeholder="City">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="">State<span class="text-danger text-bold">*</span>:</label>
                                    <input type="text" name="state" id="" class="form-control" placeholder="State">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="">Pincode<span class="text-danger text-bold">*</span>:</label>
                                    <input type="text" name="pincode" id="" class="form-control" placeholder="481001">
                                </div>
                            </div>

                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="">Country<span class="text-danger text-bold">*</span>:</label>
